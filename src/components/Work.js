  ...
  return (
    <div className='work-section-wrapper'>
        <div className='work-section-top'>
            ...
            <p className='primary-text'>we understand the importance of good service. Our friendly staff is here to ensure you have a pleasant dining experience from start to finish.</p>
        </div>
